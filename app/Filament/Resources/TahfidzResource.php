...
use App\Filament\Resources\TahfidzResource\RelationManagers;
...
class TahfidzResource extends Resource
{
   ...
   Tables\Actions\DeleteAction::make(),
    ...
    {
        return [
            'index' => Pages\ListTahfidzs::route('/'),
            'create' => Pages\CreateTahfidz::route('/create'),
            'edit' => Pages\EditTahfidz::route('/{record}/edit'),
        ];
    }
}
